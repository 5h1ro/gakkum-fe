...
import { useCreateStatusDataMutation } from '../../../../api/setting.api';
...
export default function CreateStatusData(props: createStatusProps) {
    ...
    const [createStatusData, { isLoading }] = useCreateStatusDataMutation();
    const handleSave = async () => {
        ...
        try {
            await createStatusData(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
