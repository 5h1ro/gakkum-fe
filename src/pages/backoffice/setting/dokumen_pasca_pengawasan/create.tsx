...
import { useCreateDokumenPascaPengawasanPengaturanMutation } from '../../../../api/setting.api';
import UseSwitchesCustom from '../../../../components/atoms/Switch';

interface createDokumenPascaPengawasanProps {
    showSnackBar: snackbarType
    setShowSnackbar: Dispatch<React.SetStateAction<snackbarType>>
}
export default function CreateDokumenPascaPengawasan(props: createDokumenPascaPengawasanProps) {
    ...
    const [createDokumenPascaPengawasan, { isLoading }] = useCreateDokumenPascaPengawasanPengaturanMutation();
    const handleSave = async () => {
        ...
        try {
            await createDokumenPascaPengawasan(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
        ...
        <Layout>
            ...
            <Grid2 container alignContent={'center'}>
                ...
                <Typography className="w-10/12 text-4xl font-semibold text-base-dark pt-1">
                    Create Dokumen Pasca Pengawasan
                </Typography>
            </Grid2>
