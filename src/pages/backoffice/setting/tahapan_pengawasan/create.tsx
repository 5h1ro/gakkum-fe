...
import { useCreateTahapanPengawasanPengaturanMutation } from '../../../../api/setting.api';
import UseSwitchesCustom from '../../../../components/atoms/Switch';

interface createTahapanPengawasanProps {
    showSnackBar: snackbarType
    setShowSnackbar: Dispatch<React.SetStateAction<snackbarType>>
}
export default function CreateTahapanPengawasan(props: createTahapanPengawasanProps) {
    ...
    const [createTahapanPengawasan, { isLoading }] = useCreateTahapanPengawasanPengaturanMutation();
    const handleSave = async () => {
        ...
        try {
            await createTahapanPengawasan(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
