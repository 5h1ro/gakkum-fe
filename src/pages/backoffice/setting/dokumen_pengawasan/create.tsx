...
import { useCreateDokumenPengawasanPengaturanMutation } from '../../../../api/setting.api';
import UseSwitchesCustom from '../../../../components/atoms/Switch';

interface createDokumenPengawasanProps {
    showSnackBar: snackbarType
    setShowSnackbar: Dispatch<React.SetStateAction<snackbarType>>
}
export default function CreateDokumenPengawasan(props: createDokumenPengawasanProps) {
    ...
    const [createDokumenPengawasan, { isLoading }] = useCreateDokumenPengawasanPengaturanMutation();
    const handleSave = async () => {
        ...
        try {
            await createDokumenPengawasan(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
