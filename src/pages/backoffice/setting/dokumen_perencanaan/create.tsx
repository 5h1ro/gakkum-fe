...
import { useCreateDokumenPerencanaanPengaturanMutation } from '../../../../api/setting.api';
import UseSwitchesCustom from '../../../../components/atoms/Switch';

interface createDokumenPerencanaanProps {
    showSnackBar: snackbarType
    setShowSnackbar: Dispatch<React.SetStateAction<snackbarType>>
}
export default function CreateDokumenPerencanaan(props: createDokumenPerencanaanProps) {
    ...
    const [createDokumenPerencanaan, { isLoading }] = useCreateDokumenPerencanaanPengaturanMutation();
    const handleSave = async () => {
        ...
        try {
            await createDokumenPerencanaan(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
