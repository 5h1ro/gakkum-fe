...
import { useCreateSumberDataMutation } from '../../../../api/setting.api';
import UseSwitchesCustom from '../../../../components/atoms/Switch';

interface createSumberDataProps {
    showSnackBar: snackbarType
    setShowSnackbar: Dispatch<React.SetStateAction<snackbarType>>
}
export default function CreateSumberData(props: createSumberDataProps) {
    ...
    const [createSumberData, { isLoading }] = useCreateSumberDataMutation();
    const handleSave = async () => {
        ...
        try {
            await createSumberData(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
