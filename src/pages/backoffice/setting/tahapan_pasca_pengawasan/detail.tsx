...
import { useGetDetailTahapanPascaPengawasanPengaturanQuery } from '../../../../api/setting.api';

export default function DetailTahapanPascaPengawasan() {
        ...
        <Layout>
            <Grid2 container alignContent={'center'}>
                ...
                <Typography className="w-10/12 text-4xl font-semibold text-base-dark pt-1">
                    Detail Tahapan Pasca Pengawasan
                </Typography>
            </Grid2>
