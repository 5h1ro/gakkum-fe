...
import { useCreateTahapanPascaPengawasanPengaturanMutation } from '../../../../api/setting.api';
import UseSwitchesCustom from '../../../../components/atoms/Switch';

interface createTahapanPascaPengawasanProps {
    showSnackBar: snackbarType
    setShowSnackbar: Dispatch<React.SetStateAction<snackbarType>>
}
export default function CreateTahapanPascaPengawasan(props: createTahapanPascaPengawasanProps) {
    ...
    const [createTahapanPascaPengawasan, { isLoading }] = useCreateTahapanPascaPengawasanPengaturanMutation();
    const handleSave = async () => {
        ...
        try {
            await createTahapanPascaPengawasan(formData).unwrap();
            setShowSnackbar({
                isOpen: true,
        ...
        <Layout>
            ...
            <Grid2 container alignContent={'center'}>
                ...
                <Typography className="w-10/12 text-4xl font-semibold text-base-dark pt-1">
                    Create Tahapan Pasca Pengawasan
                </Typography>
            </Grid2>
