...
import { Alert, Autocomplete, Button, Card, CardContent, IconButton, InputAdornment, MenuItem, Select, Snackbar, Stack, TextField, Typography } from '@mui/material';
...
import { useCreateCompanyPengaturanMutation, useGetProvincePengaturanQuery, useLazyGetCityPengaturanQuery, useLazyGetDistrictPengaturanQuery, useLazyGetPostalCodePengaturanQuery, useLazyGetVillagePengaturanQuery } from '../../../../api/setting.api';
...
export default function CreateCompany(props: companyProps) {
    ...
    const [company, { isLoading }] = useCreateCompanyPengaturanMutation();
