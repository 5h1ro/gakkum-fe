...
import { useCreatePetaMasalahMutation, useGetBadanUsahaQuery, useGetRegistrasiQuery, useGetStatusDataQuery, useGetSumberDataQuery } from '../../../../api/register.api';

export default function PerencanaanDaftarDetailA() {
