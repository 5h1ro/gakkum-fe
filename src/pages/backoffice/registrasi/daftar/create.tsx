...
export default function RegistrasiDaftarCreate() {
    ...
    const icons = [<RiHome5Line size={'16px'} />, <RiArrowLeftRightFill size={'16px'} />, <RiContactsBook2Line size={'16px'} />]
    ...
    return (
        <Layout>
            ...
            <Grid2 container rowSpacing={1} columnSpacing={{ xs: 1 }} marginTop={3}>
                <TabPanel icons={icons} labels={labels} value={value} setValue={setValue}>
